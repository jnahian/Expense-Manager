...
<script>
    ...
    export default {
        ...
        metaInfo() {
            return {title: this.$t('Edit Income')}
        },
        ...
        methods: {
            async update() {
                ...
                let {data} = await this.form.put(`/api/income/${id}`);
                this.$toast.success(this.$t('Income updated successfully.'));
                this.$router.push({name: 'income'});
            },

            async getDetails() {
                let id = this.$route.params.id;
                let {data} = await this.form.get(`/api/income/${id}`);
                this.income = data;
            }
        },
